    ...
    return (
        <div className="Footer">
            <div className="ProductHunt wrapper block fixed">
                ...
                <a href="https://www.producthunt.com/posts/own-the-2020s?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-own-the-2020s" target="_blank" rel="noopener noreferrer"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=179562&theme=light" alt="Own the 2020s! - This decade, give up time to gain time | Product Hunt Embed" width="250px" height="54px" /></a>
